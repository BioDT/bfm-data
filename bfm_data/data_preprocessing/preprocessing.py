...
from bfm_data.data_preprocessing.cleaning.audio import reduce_noise, remove_silence
from bfm_data.data_preprocessing.cleaning.edna import (
    clean_sequence,
    replace_ambiguous_bases,
)
from bfm_data.data_preprocessing.cleaning.image import (
    blur_image,
    denoise_image,
    resize_crop_image,
)
from bfm_data.data_preprocessing.cleaning.text import clean_text
from bfm_data.data_preprocessing.feature_extraction.audio import extract_mfcc
from bfm_data.data_preprocessing.feature_extraction.edna import extract_kmer_frequencies
from bfm_data.data_preprocessing.feature_extraction.image import (
    calculate_color_histogram,
    extract_hog_features,
)
from bfm_data.data_preprocessing.feature_extraction.text import extract_tfidf_features
from bfm_data.data_preprocessing.transformation.audio import (
    augment_audio,
...
from bfm_data.data_preprocessing.transformation.edna import (
    normalize_kmer_vector,
    one_hot_encode_sequence,
    vectorize_kmer_frequencies,
)
from bfm_data.data_preprocessing.transformation.image import (
    augment_image,
    convert_color_space,
    equalize_histogram,
    normalise_image,
)
from bfm_data.data_preprocessing.transformation.text import (
    bert_tokenizer,
...
def preprocess_audio(
    ...
    if augment:
        waveform = augment_audio(
            waveform, sample_rate, noise_factor, shift_factor, speed_factor
        )
