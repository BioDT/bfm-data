...
from bfm_data.data_ingestion.api_clients.bold import bold
from bfm_data.data_ingestion.api_clients.era5 import era5
from bfm_data.data_ingestion.api_clients.inaturalist import inaturalist
from bfm_data.data_ingestion.api_clients.mapoflife import mop
from bfm_data.data_ingestion.api_clients.xenocanto import xeno_canto
from bfm_data.data_ingestion.ingestion_scripts.livingplanetindex import (
    livingplanextindex,
)
from bfm_data.data_ingestion.ingestion_scripts.species_occurences import (
    gbif_species_occurrence,
)
from bfm_data.dataset_creation.create_dataset import create_dataset
...
def main():
    ...
    from bfm_data.data_ingestion.api_clients.era5 import ERA5Downloader, era5
    from bfm_data.data_ingestion.ingestion_scripts.copernicus_land import (
        run_data_download,
    )
    from bfm_data.data_ingestion.ingestion_scripts.land import run_land_merging
    from bfm_data.data_ingestion.ingestion_scripts.red_list import (
        run_redlist_data_processing,
    )
    from bfm_data.dataset_creation.create_dataset import create_dataset
    from bfm_data.dataset_creation.create_species_dataset import (
        create_species_dataset,
        debug_distribution_matching,
        process_all_folders_with_distribution,
    )
    from bfm_data.utils.merge_data import save_sorted_timestamps
